...
EditorUI::EditorWindow::EditorWindow()
{
	m_FPS = 0;
...
void EditorUI::EditorWindow::ProcessInput(GLFWwindow* window) {}

void EditorUI::EditorWindow::SetupScene()
{
...
void EditorUI::EditorWindow::RenderEditor()
{
...
void EditorUI::EditorWindow::HandlePanelDocking()
{
...
void EditorUI::EditorWindow::RunLoadedScene()
{
...
void EditorUI::EditorWindow::RenderActivePanels()
{
	m_MenuBar.OnImGuiRender();
	m_PanelManager.RenderActivePanels();
}

void EditorUI::EditorWindow::CalculateFPSFrametime()
{
